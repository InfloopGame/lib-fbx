...
- vitest 覆盖率（当前门槛 lines/statements 85 / branches 70 / functions 100）
...
- `tools/fbx-viewer`：Three.js 查看器，`pnpm viewer`；蒙皮绑定对齐 TransformLink + `mesh.matrixWorld`；骨骼场景姿势对齐 FBX 欧拉外旋/`generateTransform`
